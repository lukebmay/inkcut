...
| `agents/README.md` | Readme (extension) | When relevant to the task — open this file (add read_when frontmatter) |
...
| `agents/installed/README.md` | Readme | When relevant to the task — open this file (add read_when frontmatter) |
