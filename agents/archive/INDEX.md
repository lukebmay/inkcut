...
| --- | --- | --- | --- |
| 2026-08-01 | [cutter-path-preview-legend](entries/cutter-path-preview-legend.md) | inkcut, preview, legend | Corner legend for path layers; PainterPathPlotItem ctor fix |
...
| 2026-07-16 | [cutter-path-phase3-preview-markers](entries/cutter-path-phase3-preview-markers.md) | inkcut, preview, origin, feed | Phase 3: origin/feed markers + cut/travel layer toggles |
| 2026-07-16 | [cutter-path-phase2-device-frame](entries/cutter-path-phase2-device-frame.md) | inkcut, origin, feed_sense | Phase 2: frame.py + feed_sense |
| 2026-07-16 | [cutter-path-phase1-toolpath-plan](entries/cutter-path-phase1-toolpath-plan.md) | inkcut, toolpath, epilogue | Phase 1: ToolpathPlan separates machine epilogue from design transforms |
